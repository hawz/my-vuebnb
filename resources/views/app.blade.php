...
<head>
  ...
  <script type="text/javascript">
    window.vuebnb_listing_model = JSON.parse("{!! addslashes(json_encode($model)) !!}");
  </script>
</head>
  ...
  <div id="app">
    ...
    <div class="container">
      ...
      <div class="about">
        ...
        <p :class="{contracted: isContracted}">@{{ about }}</p>
        <button class="more" @click="isContracted = !isContracted">
          <span v-if="isContracted">+ More</span>
